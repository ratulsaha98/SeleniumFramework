...
public class AppConstants {
	...
	public static final String LOGIN_INVALID_CREDENTIALS_MESSAGE = "Warning: No match for E-Mail Address and/or Password.";
	public static final String LOGIN_MAXIMUM_ATTEMPTS_MESSAGE = "Warning: Your account has exceeded allowed number of login attempts. Please try again in 1 hour.";
	...
	public static List<String> expectedAccPageHeadersList = List.of("My Account", "My Orders", "My Affiliate Account",
			"Newsletter"); // List of method introduced after JDK 1.8
